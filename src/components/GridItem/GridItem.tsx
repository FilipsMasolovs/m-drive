...
interface GridItemProps {
  ...
  handleItemClick: (item: FileItem | FolderItem) => void
  handleDelete: (e: React.MouseEvent<HTMLButtonElement>, item: FileItem | FolderItem) => void
}

export default function GridItem({ item, handleItemClick, handleDelete }: GridItemProps) {
  return (
    <div className={styles.gridContainer} onClick={() => handleItemClick(item)}>
      ...
      <button className={styles.deleteButton} onClick={(e) => handleDelete(e, item)}>
