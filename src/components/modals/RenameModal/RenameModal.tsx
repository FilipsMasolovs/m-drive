...
import { handleRenameItem } from '~/server/actions/files/handleRenameItem'
...
export default React.memo(function RenameModal({ currentName, itemId, onRenameSuccess }: RenameModalProps) {
